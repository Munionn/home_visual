use actix_web::web;
use crate::handlers::{
    auth_handler, home_handler, room_handler, device_handler,
    robot_handler, scene_handler, automation_handler
};
        ...
        web::scope("/api")
            ...
            .service(
                web::scope("/devices")
                    ...
                    .route("/{id}/command", web::post().to(device_handler::send_command))
            )
            .service(
                web::scope("/robot")
                    ...
                    .route("/tasks/{id}/cancel", web::post().to(robot_handler::cancel_task))
            )
            .service(
                web::scope("/scenes")
                    ...
                    .route("/{id}/activate", web::post().to(scene_handler::activate_scene))
            )
            .service(
                web::scope("/automations")
                    ...
                    .route("/{id}", web::get().to(automation_handler::get_automation))
                    .route("/{id}", web::put().to(automation_handler::update_automation))
                    .route("/{id}", web::delete().to(automation_handler::delete_automation))
                    .route("/{id}/toggle", web::post().to(automation_handler::toggle_automation))
            )
    );
}
